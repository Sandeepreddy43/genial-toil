...
/**
 * Servlet implementation class AddMaterialGrade
 */
@WebServlet("/AddMaterialGrade")
public class AddMaterialGrade extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddMaterialGrade() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Raw_Material_crud.addMaterialGrade(material_name, material_type);
